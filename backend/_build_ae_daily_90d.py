...
CREATE TABLE public.ae_daily_90d (
    ...
    unique_link_clicks bigint DEFAULT 0,    -- unique_inline_link_clicks from primary_table
    thruplays         bigint,
...
INSERT INTO public.ae_daily_90d (
    ...
    outbound_clicks, link_clicks_raw, unique_link_clicks,
    thruplays, three_sec_plays, post_engagements,
...
combined AS (
  SELECT p.ad_id, p.date, p.account_name, p.ad_name, p.ad_status,
         ...
         p.outbound_clicks, p.inline_link_clicks, p.unique_link_clicks,
         p.thruplays, p.three_sec_video_plays,
  ...
  SELECT b.ad_id, b.date, b.account_name, b.ad_name, b.ad_status,
         ...
         NULL::bigint AS unique_link_clicks,
         b.thruplays, b.three_sec_video_plays,
...
SELECT
    ...
    COALESCE(d.unique_link_clicks, 0)::bigint         AS unique_link_clicks,
